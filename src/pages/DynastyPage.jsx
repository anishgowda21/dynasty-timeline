...
const DynastyPage = () => {
  ...
  const handleDelete = () => {
    if (window.confirm(`Are you sure you want to delete the ${dynasty.name} dynasty? This will also delete all rulers and associated events.`)) {
      deleteDynasty(id);
      navigate('/');
    }
  };
  ...
  return (
    <div>
      <div className="mb-6">
        <Link to="/" className="text-dynasty-primary hover:underline flex items-center">
        ...
        {isEditing ? (
          ...
          <>
            <div className="flex justify-between items-start mb-4">
              <div>
                <h1 className="text-3xl font-bold" style={{ color: dynasty.color }}>
                  {dynasty.name}
                </h1>
            ...
            {dynasty.description && (
              <div className="mb-6">
                <h2 className="text-lg font-semibold mb-2">About this Dynasty</h2>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        {dynastyKings.length > 0 ? (
          ...
          <p className="text-gray-500 text-center py-4">No rulers added to this dynasty yet.</p>
        )}
      </div>
      ...
      {dynastyKings.length === 0 ? (
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          <p className="text-xl text-gray-500 mb-4">No rulers added to this dynasty yet.</p>
          <button 
            onClick={() => setShowAddModal(true)}
            className="btn btn-primary"
          >
